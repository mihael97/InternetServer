...
/**
 * Class implements {@link IWebWorker} and represents <code>hello screen</code>
 * to user. On screen,process method prints <code>current date and time</code>
 * and <code>name length</code> ,if it exists
 * 
 * @author Mihael
 *
 */
